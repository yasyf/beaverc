...
%define api.prefix {bc}
%define api.token.prefix {TBC_}
%parse-param {yyscan_t yyscanner} {BC::Function*& out}
...
%code provides{
YY_DECL;
int yyerror(BCLTYPE * yylloc, yyscan_t yyscanner, BC::Function*& out, const char* message);
}
...
%union {
    ...
    BC::Function*   func;
    vector<shared_ptr<BC::Function>>*   funclist;

    vector<string>* identlist;

    BC::Instruction* inst;
    vector<BC::Instruction>* instlist;


    BC::Constant* constant;
    vector<shared_ptr<BC::Constant>>* constantlist;
}
